## Android agent 1.7.0 (September 6, 2026)

* Added manual Community enrollment from the Android app.
* Added signed APK command polling, SHA-256 verification, and user-approved installation notifications.
